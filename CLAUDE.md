...
- `infrastructure/cilium/ciliumnetpol-pve-scrape.yaml` — Prometheus → Proxmox node exporters (toCIDR 192.168.22.0/24, ports 9100/9221/9283). 9283 (Ceph MGR exporter) was added 2026-08-04 and **also needs a pfSense APP_VLAN(33)→PMX_VLAN(22) rule that does not exist yet** — `pve-firewall` already accepts it, pfSense doesn't, so those 3 targets stay down until that's added by hand. See `UPDATES.md` (2026-08-04).
