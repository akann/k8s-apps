...
Sentry SDK integration exists in 15 app services across 6 repos (org `yanatech-tech-limited`): yanatech, akan, shared-services' email-api/email-service, ml's k8s-docs/ops-agent, and yana-stocks' frontend/auth-service/profile-service/portfolio-service/portfolio-api/price-processor/price-ingestor/sentiment-analyzer/ml-predictor. (A prior version of this doc listed only 11 — it missed yana-stocks' auth-service, price-ingestor, sentiment-analyzer, ml-predictor, and ml/ops-agent, all of which were already wired up in code.)
